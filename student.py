...
class StudentClass:
    def __init__(self, root):
        ...
        Label(self.root,text="Course",font=("goudy old style", 15, "bold"), bg="white").place(x=10, y=190)
        Label(self.root,text="Roll",font=("goudy old style", 15, "bold"), bg="white").place(x=10, y=140)     
